/**
 * SOLO LECTURA. Dump de definiciones vivas de RPCs por nombre desde el catálogo
 * real de STG (pg_proc), no desde archivos de migración — que pueden estar
 * desalineados con lo aplicado a mano. Usar como base antes de escribir una
 * migración que modifique una función existente.
 * Uso: npx tsx scripts/diag/rpc-defs-dump.ts nombre_funcion_1 nombre_funcion_2 ...
 */
